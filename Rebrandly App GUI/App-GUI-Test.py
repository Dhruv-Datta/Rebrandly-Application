...
def create_rebranded_link():
    ...
    show_rebranded_link.insert("1.0", f"Link: {data_for_link['link']}{data_for_link['slashtag']}{data_for_link['title']}", "center")
    show_rebranded_link.grid(row=1, column=0, padx=0, pady=65, sticky='n', columnspan=3)
